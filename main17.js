...
document.addEventListener('DOMContentLoaded', function() {
  ...
  function showPre(index) {
    ...
    if (div4) div4.style.display = (index >= 2 && index < 10) || (index > 24  && index <= 25) || (index > 100) ? 'block' : 'none';
    ...
    if (div5) div5.style.display = (index >= 0 && index < 2) || (index > 9  && index <= 24) || (index > 25 && index <=　80) || (index > 100 && index <=　100) || (index > 100 && index <=　100) ? 'block' : 'none';
