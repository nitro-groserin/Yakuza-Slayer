...
document.addEventListener('DOMContentLoaded', function() {
  ...
  function showPre(index) {
    ...
    if (div4) div4.style.display = (index >= 81 && index < 82) || (index > 82  && index <= 100) || (index > 100) ? 'block' : 'none';
    ...
    if (div5) div5.style.display = (index >= 0 && index < 81) || (index > 81  && index <= 82) || (index > 100) ? 'block' : 'none';
