const audioPaths = [
  ...
  { src: '', volume: 0.2 }, // 1曲目
  { src: '', volume: 0.2 }, // 1曲目
  { src: '/sound-box②/アスファルトの上を歩く2.mp3', volume: 1.0 }, // 1曲目

  { src: '/sound-box②/アスファルトの上を歩く1.mp3', volume: 1.0 }, // 1曲目
  { src: '/sound-box②/崩壊都市ー街道ー.mp3', volume: 0.3 }, // 2曲目
  { src: '/sound-gun-box/夜の繁華街.mp3', volume: 0.4 }, // 3曲目
  { src: '', volume: 0.4 }  // 4曲目
];
...
document.addEventListener('DOMContentLoaded', function() {
  ...
  function showPre(index) {
    ...
    if (div6) div6.style.display = (index >= 0 && index < 100) || (index > 100 && index <= 100) ? 'block' : 'none';
    if (div3) div3.style.display = (index >= 70 && index < 75) || (index > 82  && index <= 83) || (index > 84 &&index <= 85) ? 'block' : 'none';
    
    if (div4) div4.style.display = (index >= 0 && index < 6) || (index > 90  && index <= 95) || (index > 100) ? 'block' : 'none';
    
    
    if (div1) div1.style.display = (index >= 0 && index < 80) || (index > 83  && index <= 86) || (index > 87 && index <=　100) || (index > 110 && index <=　110) || (index > 120 && index <=　120) || (index > 130 && index <= 130)  ? 'block' : 'none';
    
    
    if (div2) div2.style.display = (index >= 80 && index < 81) || (index > 82  && index <= 84) || (index > 100 && index <=　100) || (index > 110 && index <=　110) || (index > 120 && index <=　120) || (index > 130 && index <= 130)  ? 'block' : 'none';
    
    
    if (div5) div5.style.display = (index >= 6 && index < 81) || (index > 83  && index <= 84) || (index > 85 && index <=　90) || (index > 100 && index <=　100) || (index > 100 && index <=　100) ? 'block' : 'none';

    
    if (div7) div7.style.display = index >= 80 && index < 90 ? 'block' : 'none';
    if (div8) div8.style.display = index >= 80 && index < 95 ? 'block' : 'none';
