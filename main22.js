...
document.addEventListener('DOMContentLoaded', function() {
  ...
  function showPre(index) {
    ...
    if (div3) div3.style.display = (index >= 80 && index < 81) || (index > 82  && index <= 83) || (index > 84 &&index <= 85) ? 'block' : 'none';
    
    if (div4) div4.style.display = (index >= 0 && index < 5) || (index > 60  && index <= 80) || (index > 100) ? 'block' : 'none';
    
    
    if (div1) div1.style.display = (index >= 0 && index < 5) || (index > 29  && index <= 90) || (index > 100 && index <=　100) || (index > 110 && index <=　110) || (index > 120 && index <=　120) || (index > 130 && index <= 130)  ? 'block' : 'none';
    
    
    if (div2) div2.style.display = (index >= 5 && index < 30) || (index > 90  && index <= 90) || (index > 100 && index <=　100) || (index > 110 && index <=　110) || (index > 120 && index <=　120) || (index > 130 && index <= 130)  ? 'block' : 'none';
    ...
    if (div8) div8.style.display = index >= 5 && index < 100 ? 'block' : 'none';
