const audioPaths = [
  { src: '/sound-box②/激しい格闘シーン.mp3', volume: 0.4 }, // 1曲目
  { src: '/sound-box②/ROKETMAN STAGE（SAPPHO）.mp3', volume: 0.2 }  // 2曲目
];
...
document.addEventListener('DOMContentLoaded', function() {
  ...
  function showPre(index) {
    ...
    if (div6) div6.style.display = (index >= 32 && index < 44) || (index > 44 && index <= 100) ? 'block' : 'none';
    ...
    if (div2) div2.style.display = (index >= 44 && index < 45) || (index > 100  && index <= 100) || (index > 100) ? 'block' : 'none';
    if (div5) div5.style.display = (index >= 0 && index < 29) || (index > 100  && index <= 100) || (index > 100) ? 'block' : 'none';
