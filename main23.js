const audioPaths = [
  ...
  { src: '', volume: 0.2 }, // 1曲目
  { src: '', volume: 0.3 }, // 2曲目
  { src: '/sound-box②/激しい格闘シーン.mp3', volume: 0.4 }, // 3曲目
  { src: '/sound-box/バリケードマンステージ（SAPPHO）.mp3', volume: 0.2 }  // 4曲目
];
...
document.addEventListener('DOMContentLoaded', function() {
  ...
  function showPre(index) {
    ...
    if (div6) div6.style.display = (index >= 25 && index < 100) || (index > 100 && index <= 100) ? 'block' : 'none';
    if (div3) div3.style.display = (index >= 5 && index < 25) || (index > 82  && index <= 83) || (index > 84 &&index <= 85) ? 'block' : 'none';
    
    if (div4) div4.style.display = (index >= 80 && index < 85) || (index > 90  && index <= 95) || (index > 100) ? 'block' : 'none';
    
    
    if (div1) div1.style.display = (index >= 0 && index < 30) || (index > 33  && index <= 36) || (index > 37 && index <=　100) || (index > 110 && index <=　110) || (index > 120 && index <=　120) || (index > 130 && index <= 130)  ? 'block' : 'none';
    
    
    if (div2) div2.style.display = (index >= 30 && index < 34) || (index > 36  && index <= 37) || (index > 100 && index <=　100) || (index > 110 && index <=　110) || (index > 120 && index <=　120) || (index > 130 && index <= 130)  ? 'block' : 'none';
    ...
    if (div8) div8.style.display = index >= 0 && index < 5 ? 'block' : 'none';
