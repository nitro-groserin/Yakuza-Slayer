const audioPaths = [
  { src: '', volume: 0.2 }, // 1曲目
  { src: '/sound-box/Police_Car-Siren03-01(Close).mp3', volume: 0.2 }, // 2曲目
  { src: '/sound-box/焚き火.mp3', volume: 1.0 }, // 3曲目
  { src: '', volume: 0.4 }  // 4曲目
];
...
document.addEventListener('DOMContentLoaded', function() {
  ...
  function showPre(index) {
    ...
    if (div4) div4.style.display = (index >= 50 && index < 50) || (index > 50  && index <= 50) || (index > 100) ? 'block' : 'none';
    
    if (div1) div1.style.display = (index >= 0 && index < 150 ) || (index > 150) ? 'block' : 'none';
    
    
    if (div2) div2.style.display = (index >= 0 && index < 46) || (index > 90  && index <= 90) || (index > 100 && index <=　100) || (index > 110 && index <=　110) || (index > 120 && index <=　120) || (index > 130 && index <= 130)  ? 'block' : 'none';
    
    
    if (div5) div5.style.display = (index >= 46 && index < 50) || (index > 60  && index <= 60) || (index > 70 && index <=　80) || (index > 100 && index <=　100) || (index > 100 && index <=　100) ? 'block' : 'none';

    
    if (div7) div7.style.display = index >= 100 && index < 100 ? 'block' : 'none';
    if (div8) div8.style.display = index >= 100 && index < 100 ? 'block' : 'none';
