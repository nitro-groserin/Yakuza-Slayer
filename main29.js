...
document.addEventListener('DOMContentLoaded', function() {
  ...
  function showPre(index) {
    ...
    if (div1) div1.style.display = (index >= 0 && index < 8) || (index > 8 && index <= 86) || (index > 87 && index <=　100) || (index > 110 && index <=　110) || (index > 120 && index <=　120) || (index > 130 && index <= 130)  ? 'block' : 'none';
    ...
    if (div7) div7.style.display = index >= 20 && index < 90 ? 'block' : 'none';
    
    
    
    if (div8) div8.style.display = (index >= 8 && index < 9) || (index > 82  && index <= 84) || (index > 100 && index <=　100) || (index > 110 && index <=　110) || (index > 120 && index <=　120) || (index > 130 && index <= 130)  ? 'block' : 'none';
