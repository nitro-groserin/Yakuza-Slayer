const audioPaths = [
  { src: '/sound-eat-box/juice-01.mp3', volume: 0.5 }, // 1曲目
  { src: '/sound-eat-box/mensusuru-01.mp3', volume: 0.3 }, // 1曲目
  { src: '/sound-eat-box/飲む.mp3', volume: 1.0 }, // 1曲目
  { src: '/sound-eat-box/咀嚼.mp3', volume: 0.5 }, // 1曲目
  { src: '/sound-eat-box/咀嚼2.mp3', volume: 0.4 }, // 1曲目
  { src: '', volume: 0.2 }, // 1曲目
  { src: '', volume: 0.2 }, // 1曲目
  { src: '/sound-eat-box/茶碗を置く.mp3', volume: 0.5 }, // 1曲目

  { src: '/sound-box/sei_ge_otyawan_gatugatu01.mp3', volume: 0.2 }, // 1曲目
  { src: '/sound-eat-box/nomu.mp3', volume: 0.3 }, // 2曲目
  { src: '/sound-eat-box/グラスに水を注ぐ.mp3', volume: 0.5 }, // 3曲目
  { src: '', volume: 0.1 }  // 4曲目
];
...
document.addEventListener('DOMContentLoaded', function() {
  ...
  function showPre(index) {
    ...
    if (div3) div3.style.display = index >= 100 && index <= 100 ? 'block' : 'none';
    if (div6) div6.style.display = (index >= 100 && index < 100) || (index > 100 && index <= 100) ? 'block' : 'none';
    if (div3) div3.style.display = (index >= 50 && index < 50) || (index > 60  && index <= 60) || (index > 70 &&index <= 70) ? 'block' : 'none';
    
    if (div4) div4.style.display = (index >= 6 && index < 47) || (index > 80  && index <= 80) || (index > 100) ? 'block' : 'none';
    
    
    if (div1) div1.style.display = (index >= 0 && index < 50) || (index > 52  && index <= 90) || (index > 100 && index <=　100) || (index > 110 && index <=　110) || (index > 120 && index <=　120) || (index > 130 && index <= 130)  ? 'block' : 'none';
    
    
    if (div2) div2.style.display = (index >= 11 && index < 33) || (index > 90  && index <= 90) || (index > 100 && index <=　100) || (index > 110 && index <=　110) || (index > 120 && index <=　120) || (index > 130 && index <= 130)  ? 'block' : 'none';
    
    
    if (div5) div5.style.display = (index >= 47 && index < 52) || (index > 53  && index <= 54) || (index > 75 && index <=　80) || (index > 100 && index <=　100) || (index > 100 && index <=　100) ? 'block' : 'none';

    
    if (div7) div7.style.display = index >= 0 && index < 6 ? 'block' : 'none';
    if (div8) div8.style.display = index >= 50 && index < 54 ? 'block' : 'none';
    if (div9) div9.style.display = index >= 80 && index < 100 ? 'block' : 'none';
