...
let currentTrack = 0;
let audio = new Audio(audioPaths[currentTrack].src);
audio.volume = audioPaths[currentTrack].volume;
...
audio.addEventListener('ended', () => {
  if (isPlaying) {
    ...
    audio.src = audioPaths[currentTrack].src;
    audio.volume = audioPaths[currentTrack].volume;
    audio.play();
  }
});
...
document.addEventListener('DOMContentLoaded', function() {
  ...
  function showPre(index) {
    ...
    if (div2) div2.style.display = (index >= 50 && index < 54) || (index > 150) ? 'block' : 'none';
    if (div3) div3.style.display = index >= 42 && index <= 59 ? 'block' : 'none';
    if (div6) div6.style.display = (index >= 30 && index < 47) || (index > 54 && index <= 60) ? 'block' : 'none';
    if (div3) div3.style.display = index >= 2 && index <= 150 ? 'block' : 'none';
    if (div4) div4.style.display = index >= 2 && index <= 150 ? 'block' : 'none';
    if (div1) div1.style.display = (index >= 0 && index < 2) || (index > 150) ? 'block' : 'none';
    if (div5) div5.style.display = (index >= 7 && index < 30) || (index > 47 && index <= 54) || (index > 60) ? 'block' : 'none';
