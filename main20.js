const audioPaths = [
  ...
  { src: '', volume: 0.8 }, // 2曲目
  { src: '', volume: 0.6 }, // 3曲目
  { src: '/sound-box②/中華風もどき(鬼堂 火猫).mp3', volume: 0.1 }  // 4曲目
];
...
document.addEventListener('DOMContentLoaded', function() {
  ...
  function showPre(index) {
    ...
    if (div4) div4.style.display = (index >= 5 && index < 50) || (index > 80  && index <= 80) || (index > 100) ? 'block' : 'none';
    
    
    if (div1) div1.style.display = (index >= 0 && index < 11) || (index > 32  && index <= 90) || (index > 100 && index <=　100) || (index > 110 && index <=　110) || (index > 120 && index <=　120) || (index > 130 && index <= 130)  ? 'block' : 'none';
    ...
    if (div5) div5.style.display = (index >= 0 && index < 2) || (index > 3  && index <= 4) || (index > 75 && index <=　80) || (index > 100 && index <=　100) || (index > 100 && index <=　100) ? 'block' : 'none';

    
    if (div7) div7.style.display = index >= 2 && index < 3 ? 'block' : 'none';
    if (div8) div8.style.display = index >= 3 && index < 4 ? 'block' : 'none';
    if (div9) div9.style.display = index >= 46 && index < 100 ? 'block' : 'none';
