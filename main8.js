...
document.addEventListener('DOMContentLoaded', function() {
  ...
  function showPre(index) {
    ...
    if (div2) div2.style.display = (index >= 0 && index < 55) || (index > 55  && index <= 100) || (index > 100) ? 'block' : 'none';
    if (div5) div5.style.display = (index >= 100 && index < 100) || (index > 100  && index <= 100) || (index > 100) ? 'block' : 'none';
