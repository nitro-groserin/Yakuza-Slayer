...
document.addEventListener('DOMContentLoaded', function() {
  ...
  function showPre(index) {
    ...
    if (div3) div3.style.display = (index >= 0 && index < 75) || (index > 82  && index <= 83) || (index > 84 &&index <= 85) ? 'block' : 'none';
    
    if (div4) div4.style.display = (index >= 80 && index < 85) || (index > 90  && index <= 95) || (index > 100) ? 'block' : 'none';
    
    
    if (div1) div1.style.display = (index >= 0 && index < 9) || (index > 15  && index <= 86) || (index > 87 && index <=　100) || (index > 110 && index <=　110) || (index > 120 && index <=　120) || (index > 130 && index <= 130)  ? 'block' : 'none';
    ...
    if (div5) div5.style.display = (index >= 80 && index < 81) || (index > 83  && index <= 84) || (index > 85 && index <=　90) || (index > 100 && index <=　100) || (index > 100 && index <=　100) ? 'block' : 'none';
    ...
    if (div8) div8.style.display = (index >= 9 && index < 16) || (index > 82  && index <= 84) || (index > 100 && index <=　100) || (index > 110 && index <=　110) || (index > 120 && index <=　120) || (index > 130 && index <= 130)  ? 'block' : 'none';
