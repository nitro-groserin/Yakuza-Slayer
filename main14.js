...
document.addEventListener('DOMContentLoaded', function() {
  ...
  function showPre(index) {
    ...
    if (div3) div3.style.display = (index >= 7 && index < 8) || (index > 8  && index <= 9) || (index > 10 &&index <= 11) ? 'block' : 'none';
    ...
    if (div2) div2.style.display = (index >= 2 && index < 3) || (index > 5  && index <= 6) || (index > 7 && index <=　8) || (index > 9 && index <=　10) || (index > 11 && index <=　16) || (index > 34 && index <= 100)  ? 'block' : 'none';
    
    
    if (div5) div5.style.display = (index >= 0 && index < 2) || (index > 2  && index <= 5) || (index > 16 && index <=　34) || (index > 100 && index <=　100) || (index > 100 && index <=　100) ? 'block' : 'none';
