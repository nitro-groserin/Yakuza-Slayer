...
document.addEventListener('DOMContentLoaded', function() {
  ...
  function showPre(index) {
    ...
    if (div4) div4.style.display = (index >= 0 && index < 3) || (index > 19  && index <= 48) || (index > 100) ? 'block' : 'none';
    
    if (div1) div1.style.display = (index >= 0 && index < 150 ) || (index > 150) ? 'block' : 'none';
    if (div2) div2.style.display = (index >= 49 && index < 50) || (index > 100  && index <= 100) || (index > 100) ? 'block' : 'none';
    if (div5) div5.style.display = (index >= 3 && index < 20) || (index > 49  && index <= 100) || (index > 100) ? 'block' : 'none';
