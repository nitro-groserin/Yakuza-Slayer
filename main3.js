const audioPaths = [
  ...
  { src: '/sound-box3/自家製雨.mp3', volume: 1.0 }, // 1曲目
...
document.addEventListener('DOMContentLoaded', function() {
  ...
  function showPre(index) {
    ...
    if (div2) div2.style.display = (index >= 0 && index < 54) || (index > 150) ? 'block' : 'none';
    ...
    if (div3) div3.style.display = index >= 24 && index <= 150 ? 'block' : 'none';
    if (div4) div4.style.display = index >= 50 && index <= 150 ? 'block' : 'none';
    if (div1) div1.style.display = (index >= 0 && index < 50) || (index > 150) ? 'block' : 'none';
    if (div5) div5.style.display = (index >= 29 && index < 30) || (index > 47 && index <= 54) || (index > 60) ? 'block' : 'none';
