...
document.addEventListener('DOMContentLoaded', function() {
  ...
  function showPre(index) {
    ...
    if (div2) div2.style.display = (index >= 24 && index < 34) || (index > 34  && index <= 100) || (index > 100) ? 'block' : 'none';
    if (div5) div5.style.display = (index >= 22 && index < 24) || (index > 33  && index <= 34) || (index > 100) ? 'block' : 'none';
