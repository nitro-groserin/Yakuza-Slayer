...
document.addEventListener('DOMContentLoaded', function() {
  ...
  function showPre(index) {
    ...
    if (div3) div3.style.display = index >= 54 && index <= 150 ? 'block' : 'none';
    ...
    if (div2) div2.style.display = (index >= 37 && index < 55) || (index > 55  && index <= 100) || (index > 100) ? 'block' : 'none';
    if (div5) div5.style.display = (index >= 1 && index < 31) || (index > 55  && index <= 55) || (index > 100) ? 'block' : 'none';
    if (div7) div7.style.display = index >= 56 && index < 60 ? 'block' : 'none';
    if (div8) div8.style.display = index >= 79 && index < 92 ? 'block' : 'none';
    if (div9) div9.style.display = index >= 32 && index < 100 ? 'block' : 'none';
