const audioPaths = [
  { src: '/sound-box②/アスファルトの上を走る2.mp3', volume: 1.0 }, // 1曲目
...
document.addEventListener('DOMContentLoaded', function() {
  ...
  function showPre(index) {
    ...
    if (div2) div2.style.display = (index >= 5 && index < 9) || (index > 55  && index <= 100) || (index > 100) ? 'block' : 'none';
    if (div5) div5.style.display = (index >= 9 && index < 100) || (index > 100  && index <= 100) || (index > 100) ? 'block' : 'none';
