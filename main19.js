...
document.addEventListener('DOMContentLoaded', function() {
  ...
  function showPre(index) {
    ...
    if (div4) div4.style.display = (index >= 6 && index < 20) || (index > 80  && index <= 80) || (index > 100) ? 'block' : 'none';
    ...
    if (div5) div5.style.display = (index >= 0 && index < 6) || (index > 19  && index <= 64) || (index > 75 && index <=　80) || (index > 100 && index <=　100) || (index > 100 && index <=　100) ? 'block' : 'none';
