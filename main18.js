const audioPaths = [
  ...
  { src: '', volume: 0.8 }, // 2曲目
  { src: '', volume: 0.6 }, // 3曲目
  { src: '/sound-box②/責任逃れ(Myu_Zo_Arrange_short.ver)(t).mp3', volume: 0.3 }  // 4曲目
];
...
document.addEventListener('DOMContentLoaded', function() {
  ...
  function showPre(index) {
    ...
    if (div4) div4.style.display = (index >= 51 && index < 79) || (index > 80  && index <= 80) || (index > 100) ? 'block' : 'none';
    ...
    if (div5) div5.style.display = (index >= 0 && index < 51) || (index > 70  && index <= 64) || (index > 75 && index <=　80) || (index > 100 && index <=　100) || (index > 100 && index <=　100) ? 'block' : 'none';

    
    if (div7) div7.style.display = index >= 100 && index < 100 ? 'block' : 'none';
    if (div8) div8.style.display = index >= 67 && index < 100 ? 'block' : 'none';
